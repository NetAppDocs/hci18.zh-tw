...
您可以手動 https://docs.netapp.com/us-en/vcp/vcp_task_clusters_manage.html#set-protection-domain-monitoring["啟用保護網域監控"^]使用 NetApp Element Plug-in for vCenter Server 。您可以根據節點或機箱網域選取保護網域臨界值。
...
請參閱。 https://docs.netapp.com/sfe-122/topic/com.netapp.doc.sfe-ug/GUID-7D31AC22-8815-4BDA-984A-9AED750B96B1.html["支援元件12.2文件中心SolidFire"^]
